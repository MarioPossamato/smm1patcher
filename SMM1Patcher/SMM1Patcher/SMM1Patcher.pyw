...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.Mario.setText('')
        self.Mario.setPixmap(QtGui.QPixmap('SMM1PatcherData/Sprites/20151007040718!SMM-SMB-Mario.png').scaled(128, 128, QtCore.Qt.KeepAspectRatio, QtCore.Qt.FastTransformation))
        ...
        self.SuperMario.setPixmap(QtGui.QPixmap('SMM1PatcherData/Sprites/SMM-SMB-SuperMario.png').scaled(128, 128, QtCore.Qt.KeepAspectRatio, QtCore.Qt.FastTransformation))
        ...
        self.HardBlock.setPixmap(QtGui.QPixmap('SMM1PatcherData/Sprites/SMM-SMB-HardBlock-Winged.png').scaled(128, 128, QtCore.Qt.KeepAspectRatio, QtCore.Qt.FastTransformation))
        ...
        self.Pipe.setText('')
        self.Pipe.setPixmap(QtGui.QPixmap('SMM1PatcherData/Sprites/SMM-SMB-PipeTop.png').scaled(128, 128, QtCore.Qt.KeepAspectRatio, QtCore.Qt.FastTransformation))
        ...
        self.Goomba.setText('')
        self.Goomba.setPixmap(QtGui.QPixmap('SMM1PatcherData/Sprites/GoombaSMM.png').scaled(128, 128, QtCore.Qt.KeepAspectRatio, QtCore.Qt.FastTransformation))
